...
<div class="row row-overflow">
  ...
  <div class="col-xs-12 eqLogicThumbnailDisplay">
    ...
    <legend><i class="fas fa-table"></i> {{Mes compteur Linky}}</legend>
    <?php
    if (count($eqLogics) == 0) {
        ...
        <form class="form-horizontal">
          <fieldset>
            <div class="col-lg-6">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label">{{Identifiant Compteur}}</label>
                <div class="col-sm-6">
                  <span class="eqLogicAttr form-control" data-l1key="logicalId"></span>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">{{Type de téléinformation}}</label>
                <div class="col-sm-6">
                  <span class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="tictype"></span>
                </div>
              </div>
            </div>
...
<?php 
include_file('desktop', 'mqttLinky', 'js', 'mqttLinky');
